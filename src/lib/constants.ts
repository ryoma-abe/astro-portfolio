...
export const WORKS = [
  ...
  },
  {
    ...
    link: 'https://rejuveec.com/',
    description: [
      '会員制のエクステ販売サイトを制作させていただきました。会員ランクシステムとInstagram連携を導入しております。高級感を出しつつ、シンプルで使い易、デザインで構築させていただきました。',
    ],
  },
  {
    project: '&ピラティス様',
    ...
    start: '2022',
    link: 'https://andpilates-fit.com/',
    description: [
      '&ピラティス様のコーディングと一部デザインを担当させていただきました。デザインカンプからのコーディング / WPのオリジナルテーマ化を実装しております。Sassを用いてコーディングし、カスタムフィールド（ACF）・カスタム投稿・MW WP Form等を使用しています',
    ],
  },
]
